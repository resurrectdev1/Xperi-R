package com.resurrect.xperi_r.ui.theme
...
val XperiRTypography = Typography(
...
fun XperiRM3Theme(
    ...
    MaterialTheme(colorScheme = colorScheme, typography = XperiRTypography, content = content)
}
