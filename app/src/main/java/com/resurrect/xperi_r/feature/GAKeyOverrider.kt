...
import com.resurrect.xperi_r.feature.GAKeyOverrider.Companion.ASSIST_BUTTON_LOG_TRIGGER
import com.resurrect.xperi_r.feature.GAKeyOverrider.Companion.GOOGLE_PACKAGE_NAME
import com.resurrect.xperi_r.feature.GAKeyOverrider.Companion.isSupported
...
class GAKeyOverrider(
    ...
    init {
        lifecycleOwner.lifecycleScope.launch {
            lifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                XperiRApplication.prefs.assistButtonFlow.collect {
    ...
    companion object {
        ...
        val isSupported =
            DeviceModel.isPDX206 || DeviceModel.isPDX213 || DeviceModel.isPDX214 || DeviceModel.isPDX215 ||
                DeviceModel.isPDX223 || DeviceModel.isPDX234
    }
}
